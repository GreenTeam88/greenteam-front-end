...
/**
 * 1) `selectedCloseStairs` must be nonempty.
 * 2) `selectedCloseStairSteps` is optional overall.
 * 3) If `selectedCloseStairs !== "0 (geen dichte trappen)"`, then `selectedCloseStairSteps` is required.
 */
const schema = z
  .object({
  ...
  return (
    <FormProvider {...form}>
      <form
        ...
        className="w-[386px]  flex rounded-[4px] relative lg:px-0 z-10 flex-col shadow-lg"
      >
