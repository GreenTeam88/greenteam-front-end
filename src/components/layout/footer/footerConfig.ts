...
export const footerColumnsInfo: FooterColumnInfo[] = [
  {
    ...
    links: [
      ...
      { name: 'BetonCiré Metal stuc', path: '/traprenovatie/betoncire-metal-stuc' },
      { name: 'BetonCiré Glamour stuc', path: '/traprenovatie/betoncire-glamour-stuc' },
      { name: 'BetonCiré Brut', path: '/traprenovatie/betoncire-brut' },
      { name: 'BetonCiré Parel', path: '/traprenovatie/betoncire-parel' },
      { name: 'BetonCiré Croco', path: '/traprenovatie/betoncire-croco' },
      { name: 'BetonCiré Venetiaans', path: '/traprenovatie/betoncire-venetiaans' },
      { name: 'BetonCiré Acoustic', path: '/traprenovatie/betoncire-acoustic' },
      { name: '', path: '' },
