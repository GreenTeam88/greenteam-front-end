    ...
    columns: [
      {
        ...
        subPages: [
          ...
          { name: 'Belakos', path: '/products/tapijten?Merk=%5B"Belakos"%5D' },
          { name: 'Bonaparte', path: '/products/tapijten?Merk=%5B"Bonaparte"%5D' },
          { name: 'Desso', path: '/products/tapijten?Merk=%5B"Desso"%5D' },
          { name: 'Forbo', path: '/products/tapijten?Merk=%5B"Forbo"%5D' },
          { name: 'Gelasta', path: '/products/tapijten?Merk=%5B"Gelasta"%5D' },
          { name: 'Hamat', path: '/products/tapijten?Merk=%5B"Hamat"%5D' },
          { name: 'Interfloor', path: '/products/tapijten?Merk=%5B"Interfloor"%5D' },
          { name: 'Lano', path: '/products/tapijten?Merk=%5B"Lano"%5D' },
          { name: 'Parade', path: '/products/tapijten?Merk=%5B"Parade"%5D' },
          { name: 'Sfeervol Wonen', path: '' },
          { name: 'Smartstrand', path: '/products/tapijten?Merk=%5B"Smartstrand"%5D' },
          { name: 'Tretford', path: '/products/tapijten?Merk=%5B"Tretford"%5D' },
        ],
      },
      {
        title: 'Materiaal',
