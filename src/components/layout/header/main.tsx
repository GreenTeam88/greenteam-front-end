  ...
  ...basicRoutes,
  {
    ...
    columns: [
      ...
      },
      {
        ...
        link: 'Kleur',
        subPages: [
          { name: 'Blauw', path: '/tapijten?colors=%5B"Blauw"%5D' },
          { name: 'Bruin en beige', path: '/tapijten?colors=%5B"Bruin en beige"%5D' },
          { name: 'Geel', path: '/tapijten?colors=%5B"Geel"%5D' },
          { name: 'Grijs', path: '/tapijten?colors=%5B"Grijs"%5D' },
          { name: 'Groen', path: '/tapijten?colors=%5B"Groen"%5D' },
          { name: 'Paars', path: '/tapijten?colors=%5B"Paars"%5D' },
          { name: 'Rood', path: '/tapijten?colors=%5B"Rood"%5D' },
          { name: 'Oranje', path: '/tapijten?colors=%5B"Oranje"%5D' },
          { name: 'Zwart', path: '/tapijten?colors=%5B"Zwart"%5D' },
          { name: 'Wit', path: '/tapijten?colors=%5B"Wit"%5D' },
        ],
      },
    ],
  },
