    ...
    columns: [
      {
        ...
        subPages: [
          { name: 'Ambiant', path: '/products/tapijten?mark=%5B"ambiant"%5D' },
          { name: 'Best Wool Carpets', path: '' },
          { name: 'Belakos', path: '/products/tapijten?mark=%5B"Belakos"%5D' },
          { name: 'Bonaparte', path: '/products/tapijten?mark=%5B"Bonaparte"%5D' },
          { name: 'Desso', path: '/products/tapijten?mark=%5B"Desso"%5D' },
          { name: 'Forbo', path: '/products/tapijten?mark=%5B"Forbo"%5D' },
          { name: 'Gelasta', path: '/products/tapijten?mark=%5B"Gelasta"%5D' },
          { name: 'Hamat', path: '/products/tapijten?mark=%5B"Hamat"%5D' },
          { name: 'Interfloor', path: '/products/tapijten?mark=%5B"Interfloor"%5D' },
          { name: 'Lano', path: '/products/tapijten?mark=%5B"Lano"%5D' },
          { name: 'Parade', path: '/products/tapijten?mark=%5B"Parade"%5D' },
          { name: 'Sfeervol Wonen', path: '' },
          { name: 'Smartstrand', path: '/products/tapijten?mark=%5B"Smartstrand"%5D' },
          { name: 'Tretford', path: '/products/tapijten?mark=%5B"Tretford"%5D' },
        ],
      },
      {
        title: 'Materiaal',
