      ...
      },
      {
        ...
        subPages: [
          ...
          { name: 'Schuren en schilderen', path: '/traprenovatie/schuren-en-schilderen' },
          {
            name: 'Beton Ciré',
            subPages: [
              { name: 'Beton Ciré Metal stuc', path: '/traprenovatie/betonCiré/betonCiré-metal-stuc' },
              { name: 'Beton Ciré Glamour stuc', path: '/traprenovatie/betonCiré/betonCiré-glamour-stuc' },
              { name: 'Beton Ciré Brut', path: '/traprenovatie/betonCiré/betonCiré-brut' },
              { name: 'Beton Ciré Parel', path: '/traprenovatie/betonCiré/betonCiré-parel' },
              { name: 'Beton Ciré Croco', path: '/traprenovatie/betonCiré/betonCiré-croco' },
              { name: 'Beton Ciré Venetiaans', path: '/traprenovatie/betonCiré/betonCiré-venetiaans' },
