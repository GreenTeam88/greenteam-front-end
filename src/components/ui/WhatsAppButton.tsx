    ...
    <AnimatePresence>
      {isVisible && (
        <motion.a
          ...
          className="fixed z-50 bottom-8 right-8 flex items-center justify-center w-14 h-14 bg-[#25D366] rounded-full shadow-lg hover:shadow-xl cursor-pointer transition-shadow duration-300"
...
const WhatsAppSVG = React.memo(({ className = '' }: { className?: string }) => {
  return (
