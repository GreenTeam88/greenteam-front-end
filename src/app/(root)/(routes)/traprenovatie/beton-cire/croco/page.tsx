...
const whatWaitingForConfig: InfoCardProps = {
  ...
  paragraphs: [
    <BodyText key="1">
      Droomt u al langere tijd van een moderne vloer met Beton Ciré Croco?  Bereken via de knop hieronder wat het kost
      en neem contact met ons op voor een afspraak. Als u de specialist langs laat komen gaan we bespreken wat voor
...
export default function TraprenovatieBetonCireCroco() {
  return (
    <div className="flex flex-col   relative z-0 items-center w-full">
      <Hero calculatorSlug="traprenovatie" imgSrc="/traprenovatie/croco/hero.png" />
      <ListCard
