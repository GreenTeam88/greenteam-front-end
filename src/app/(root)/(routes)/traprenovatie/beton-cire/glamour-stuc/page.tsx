...
const thirdSectionCards: InfoCardProps[] = [
  {
    ...
    imgSrc: '/traprenovatie/glamour-stuc/glamour-stuc-2.png',
    paragraphs: [
      <div key="1">
  ...
  {
    title: 'Glamour Stuc - luxe, elegantie en duurzaamheid',
    imgSrc: '/traprenovatie/glamour-stuc/glamour-stuc-3.png',
    paragraphs: [
      <div key="1">
        Wilt u een interieur met een moderne, verfijnde uitstraling? Beton Ciré Glamour Stuc combineert de stoere look
        van beton met een subtiele, glanzende touch. Dit hoogwaardige materiaal is de perfecte keuze voor een chique,
        tijdloos design en biedt:
      </div>,
      <ul key="3" className="flex flex-col py-3 list-disc gap-4 list-inside">
        <li>Naadloze luxe: Een strakke, glanzende afwerking die perfect past in elke ruimte. </li>
        <li>
          Waterdicht en slijtvast: Ideaal voor badkamers, keukens en woonkamers waar stijl en functionaliteit
          samenkomen. {' '}
        </li>
...
const whatWaitingForConfig: InfoCardProps = {
  ...
  paragraphs: [
    <BodyText key="1">
      Droomt u al langere tijd van een perfecte afwerking met Beton Ciré Glamour Stuc? Bereken via de knop hieronder wat
  ...
  imgSrc: '/traprenovatie/glamour-stuc/glamour-stuc-9.png',
  ...
  return (
    <div className="flex flex-col   relative z-0 items-center w-full">
      ...
      <ListCard
        ...
        imgSrc="/traprenovatie/glamour-stuc/glamour-stuc-1.png"
      ...
      <StoreSection
        ...
        btnText="Bereken uw trap"
        firstImg={'/traprenovatie/glamour-stuc/glamour-stuc-4.png'}
        secondImg="/traprenovatie/glamour-stuc/glamour-stuc-5.png"
