...
const infoCardConfig: InfoCardProps = {
  ...
  paragraphs: [
    <BodyText key="1">
      ...
      onderhouden moeten worden en worden geschuurd. Op deze manier kunt u alle gebruikssporen laten verdwijnen en is uw
      houten vloer weer zo goed als nieuw. Ligt uw vloer er al 10 tot 20 jaar dan is het de hoogste tijd om daar wat aan
      te doen!
    </BodyText>,
