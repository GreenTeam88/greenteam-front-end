...
export const WhatWaitingForCard: React.FC<InfoCardProps> = ({
  ...
  return (
    <div
      className={cn(
        'flex w-full py-[99px]  p-3 lg:py-[120px] flex-col lg:flex-row  items-center justify-center gap-4 lg:gap-[57px]',
        className
      )}
    >
      <div className="flex flex-col max-w-[508px]  px-4 lg:px-0 gap-1 lg:gap-[33px] ">
