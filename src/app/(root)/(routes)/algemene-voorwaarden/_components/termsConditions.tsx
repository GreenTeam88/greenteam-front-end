  ...
  return (
    <div className="flex gap-[44px] py-14 termsConditions flex-col-reverse px-10  lg:flex-row ">
      <div className="flex max-w-full lg:w-[901px] flex-col gap-[32px]">
        ...
        <div className="boxClassname">
          ...
          <div className="listContainer">
            ...
            <p className="listItem">
              1.3. Opdrachtgever: de natuurlijke persoon of onderneming met wie GreenTeam een overeenkomst heeft
            ...
            <p className="listItem">
              1.6. Producten: de door GreenTeam aan opdrachtgever op basis van de overeenkomst te leveren goederen en
              toebehoren.
            </p>
            <p className="listItem">
              1.7. Diensten: het op basis van de overeenkomst monteren van producten door de opdrachtnemer.
            </p>
            <p className="listItem">
              1.8. Schriftelijk: zowel traditionele schriftelijke communicatie als communicatie per e-mail.
            </p>
          </div>
        </div>

        <div className="boxClassname">
          <h3 id="2" className="boxTitle">
            2. Toepasselijkheid algemene voorwaarden
          </h3>
          <div className="listContainer">
            <p className="listItem">
              2.1. Deze voorwaarden zijn van toepassing op alle aanbiedingen, offertes en overeenkomsten tussen
              GreenTeam en opdrachtgever waarop GreenTeam deze voorwaarden van toepassing heeft verklaard.
            </p>
            <p className="listItem">
              2.2. Afwijkingen op deze algemene voorwaarden zijn slechts geldig indien deze schriftelijk tussen
              GreenTeam en opdrachtgever zijn overeengekomen. Afwijkingen van deze algemene voorwaarden gelden slechts
              éénmalig en alleen voor de offerte of overeenkomst waarop de betreffende afwijking betrekking heeft.
            </p>
            <p className="listItem">
              2.3. Partijen sluiten de toepasselijkheid van aanvullende en/of afwijkende algemene voorwaarden van de
              opdrachtgever of derden uitdrukkelijk uit.
            </p>
            <p className="listItem">
        ...
        <div className="boxClassname">
          ...
          <div className="listContainer">
            <p className="listItem">
              ...
              de offerte, tenzij anders aangegeven. GreenTeam is slechts aan de door haar gedane offertes gebonden
            ...
            <p className="listItem">
              3.5. Indien de opdrachtgever het aanbod niet accepteert, is GreenTeam gerechtigd de kosten die gemoeid
              zijn met de totstandbrenging van de offerte in rekening te brengen, mits zij de opdrachtgever direct bij
              of na het vragen van het aanbod schriftelijk heeft gewezen op het bestaan van deze kosten en op de hoogte
              ervan. In geval GreenTeam van de in dit lid bedoelde mogelijkheid gebruik maakt en de opdrachtgever de
              desbetreffende kosten heeft voldaan, gaan de bij de offerte behorende tekeningen in eigendom over op de
              opdrachtgever, onverminderd het intellectuele en industriële eigendomsrecht van GreenTeam.
            </p>
            <p className="listItem">
        ...
        <div className="boxClassname">
          <h3 id="4" className="boxTitle">
            4. Adviezen en verstrekte informatie
          </h3>
          <div className="listContainer">
            <p className="listItem">
              4.1. Opdrachtgever kan geen rechten ontlenen aan informatie en/of adviezen die hij van opdrachtnemer heeft
              gekregen, als deze geen betrekking hebben op de overeenkomst.
            </p>
            <p className="listItem">
              4.2. Het bij een offerte meegezonden documentatie materiaal is uitsluitend informatief van karakter en er
              kunnen geen rechten aan ontleend worden, ook niet nadat de overeenkomst is gesloten, tenzij schriftelijk
              anders is bepaald.
            </p>
            <p className="listItem">
              4.2. Indien opdrachtgever aan opdrachtnemer documenten en informatie verstrekt, waaronder gegevens en
              tekeningen, dan mag opdrachtnemer bij uitvoering van de overeenkomst uitgaan van de juistheid en
            ...
            <p className="listItem">
              ...
              van door opdrachtgever verstrekte adviezen, ontwerpen, tekeningen, berekeningen, monsters, materialen,
              modellen en dergelijke.
            </p>
          </div>
        </div>
        <div className="boxClassname">
          <h3 id="5" className="boxTitle">
            5. Prijzen en tarieven
          </h3>
          <div className="listContainer">
            <p className="listItem">
              5.1. Tenzij de opdrachtgever consument is, zijn de door GreenTeam opgegeven prijzen en tarieven exclusief
            ...
            <p className="listItem">
              5.2. Indien de opdracht op locatie bij de opdrachtgever wordt uitgevoerd zijn de kosten met betrekking tot
              gas, water en elektra voor rekening van de opdrachtgever.
            </p>
            <p className="listItem">
              5.3. Partijen kunnen bij het tot stand komen van de overeenkomst een vaste prijs overeenkomen. Indien geen
            ...
            <p className="listItem">
              5.4. Bij iedere opdracht kunnen de door de opdrachtgever verschuldigde kosten periodiek, op een door
              GreenTeam bij het aangaan van de overeenkomst aangegeven wijze, in rekening worden gebracht.
            </p>
            <p className="listItem">
              5.5. GreenTeam heeft te allen tijde het recht alle kostprijsverhogende factoren die zijn ontstaan na het
            ...
            <p className="listItem">
              5.6. Elke opdrachtgever is in geval van een prijsstijging van het vaste honorarium of uurtarief van meer
            ...
            <p className="listItem">
              5.7. GreenTeam zal de opdrachtgever schriftelijk van het voornemen tot verhoging van het vaste honorarium
            ...
            <p className="listItem">
              5.8. Indien de opdrachtgever de door GreenTeam kenbaar gemaakte verhoging van het vaste honorarium of
        ...
        <div className="boxClassname" id="Verplichtingen van de opdrachtgever">
          <h3 id="6" className="boxTitle">
            6. Betalingen en betalingstermijnen
          </h3>
          <div className="listContainer">
            <p className="listItem">
              6.1. Betaling dient te geschieden binnen veertien (14) dagen na factuurdatum, op een door GreenTeam aan te
              geven wijze. Alle betalingstermijnen zijn te beschouwen als fatale termijnen, tenzij uitdrukkelijk
              schriftelijk anders is overeengekomen.
            </p>
            <p className="listItem">
              6.2. Bij overschrijding van een overeengekomen betalingstermijn wordt de volledige vordering tot betaling
              direct opeisbaar.
            </p>
            <p className="listItem">
              6.3. Elke bevoegdheid van de opdrachtgever tot verrekening of opschorting, uit welke hoofde en om welke
            ...
            <p className="listItem">
              6.6. Indien een consument opdrachtgever in gebreke blijft met tijdige en of volledige betaling zal middels
            ...
            <p className="listItem">
              6.7. In geval van wettelijke schuldsanering, liquidatie, faillissement, beslag of surseance van betaling
        ...
        <div className="boxClassname" id="Wijziging van de overeenkomst">
          ...
          <div className="listContainer">
            <p className="listItem">
              ...
              opdrachtgever gesloten overeenkomst nadat GreenTeam deze wijzigingen schriftelijk heeft aanvaard, dan wel
          ...
          <div className="listContainer">
            ...
            <p className="listItem">
              ...
              <ul className="list list-[lower-alpha] my-3 space-y-2 px-7">
                ...
                <li>
                  b. De opdrachtgever GreenTeam niet binnen 10 dagen na kennisgeving van de oplevering voorziet van
                  goedkeuring (stilzwijgende aanvaarding);
                </li>
                <li>c. Het werk door de opdrachtgever in gebruik is genomen. </li>
              </ul>
            </p>
            <p className="listItem">
          ...
          <div className="listContainer">
            ...
            <p className="listItem">
              ...
              <ul className="list list-[lower-alpha] my-3 space-y-2 px-7">
                ...
                <li>7 jaar voor gietvloeren; </li>
                <li>5 jaar voor overige vloertypen, zoals tapijt, laminaat, vinyl en kurk. </li>
              </ul>
            </p>
            <p className="listItem">
            ...
            <p className="listItem">
              ...
              <ul className="list-disc list-inside">
                ...
                <li>
                  wijziging, reparatie, installatie of montage door de opdrachtgever of derden heeft plaatsgevonden;
                </li>
                <li>
                  ongeschiktheid of gebreken van zaken of materialen die door of op aanwijzing van de opdrachtgever zijn
                  geleverd;
                </li>
                <li>gebruik van ondeugdelijke hulpmiddelen door de opdrachtgever; </li>
                <li>blootstelling aan direct zonlicht. </li>
              </ul>
            </p>
            <p className="listItem">
        ...
        <div className="boxClassname">
          ...
          <div className="listContainer">
            ...
            <p className="listItem">
              ...
              <ul className="list list-[lower-alpha] my-3 space-y-2 px-7">
                <li>
                  a. Zich omstandigheden voordoen welke van dien aard zijn dat nakoming van de overeenkomst onmogelijk
                  is geworden of naar maatstaven van redelijkheid en billijkheid niet langer kan worden gevergd, dan wel
                  indien zich anderszins omstandigheden voordoen welke van dien aard zijn dat ongewijzigde
                ...
                <li>
                  ...
                  opdrachtgever wordt aangevraagd of de opdrachtgever zelf zijn faillissement aanvraagt, de
                  opdrachtgever aan zijn schuldeisers een (onderhands) akkoord aanbiedt of (met dit doel) een
                  vergadering van schuldeisers bijeenroept of indien met betrekking tot de opdrachtgever (natuurlijk
                  persoon) toepassing wordt verzocht of verleend van de Wet schuldsanering natuurlijke personen.
                </li>
                <li>
      ...
      <div className="flex flex-col gap-[11px]">
        ...
        <a href="#1" className="text-blackDark cursor-pointer text-sm">
          1. Definities
        </a>
        <a href="#2" className="text-blackDark cursor-pointer text-sm">
          2. Toepasselijkheid algemene voorwaarden
        </a>
        <a href="#3" className="text-blackDark cursor-pointer text-sm">
          3. Offertes en totstandkoming overeenkomst
        </a>
        <a href="#4" className="text-blackDark cursor-pointer text-sm">
          4. Adviezen en verstrekte informatie
        </a>
        <a href="#5" className="text-blackDark cursor-pointer text-sm">
          5. Prijzen en tarieven
        </a>
        <a href="#6" className="text-blackDark cursor-pointer text-sm">
          6. Betalingen en betalingstermijnen
        </a>
        <a href="#7" className="text-blackDark cursor-pointer text-sm">
          7. Verplichtingen van de opdrachtgever
        </a>
        <a href="#8" className="text-blackDark cursor-pointer text-sm">
          8. Uitvoering van de overeenkomst
        </a>
        <a href="#9" className="text-blackDark cursor-pointer text-sm">
          9. Wijziging van de overeenkomst
        </a>
        <a href="#10" className="text-blackDark cursor-pointer text-sm">
          10. Levering en uitvoeringstermijn
        </a>
        <a href="#11" className="text-blackDark cursor-pointer text-sm">
          11. Garanties en overige aanspraken
        </a>
        <a href="#12" className="text-blackDark cursor-pointer text-sm">
          12. Annulering
        </a>
        <a href="#13" className="text-blackDark cursor-pointer text-sm">
          13. Opschorting en ontbinding
        </a>
        <a href="#14" className="text-blackDark cursor-pointer text-sm">
          14. Aansprakelijkheid
        </a>
        <a href="#15" className="text-blackDark cursor-pointer text-sm">
          15. Overmacht
        </a>
        <a href="#16" className="text-blackDark cursor-pointer text-sm">
          16. Eigendomsvoorbehoud
        </a>
        <a href="#17" className="text-blackDark cursor-pointer text-sm">
          17. Gebreken en klachten
        </a>
        <a href="#18" className="text-blackDark cursor-pointer text-sm">
          18. Geschillen en toepasselijk recht
        </a>
      </div>
    </div>
