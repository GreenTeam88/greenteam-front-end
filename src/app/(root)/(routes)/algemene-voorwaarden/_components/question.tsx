...
export const TermsConditionPageQuestion = () => {
  ...
  return (
    <div className="flex flex-col items-center gap-[22px] py-[55px] bg-lightOrange w-full">
      <HeadlineSemibold className="text-primaryDefault">Hebben we uw probleem kunnen oplossen?</HeadlineSemibold>
      ...
      {infoUsefull !== null &&
        (infoUsefull ? (
          <BodyText className="text-center">We zijn blij dat we u hebben kunnen helpen!</BodyText>
        ) : (
          <BodyText className="text-center">
            ...
            met ons op zodat we u verder kunnen helpen.
          </BodyText>
        ))}
    </div>
  );
