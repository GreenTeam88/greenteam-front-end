...
type IconInfo = { name: string; src: string };
const iconsInfo: IconInfo[] = [
  { name: '20 jaar ervaring', src: '/aboutUs/star.svg' },
  { name: 'Kwaliteit', src: '/aboutUs/done.svg' },
  { name: 'Duurzaam', src: '/aboutUs/heart.svg' },
  { name: 'maat', src: '/aboutUs/cards.svg' },
];
