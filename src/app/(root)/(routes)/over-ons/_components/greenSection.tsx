...
export const GreenSection = () => {
  return (
    <div className="flex relative lg:justify-end bg-primaryDefault items-center lg:items-start lg:bg-white   h-fit  py-5 lg:px-0 lg:py-0 px-4 flex-col  lg:flex-row w-full">
      <div className=" lg:absolute lg:w-[80vw] top-0 left-0 justify-center lg:justify-start flex     overflow-visible  h-full lg:-ml-[7%]">
        <img className=" hidden w-full h-full  lg:block object-cover" src="/aboutUs/greenBg.png" />
        <div className="lg:absolute gap-5 py-4 lg:max-w-[70%] relative  lg:py-0 lg:top-1/2 items-center lg:items-start lg:-translate-y-1/2 lg:left-[20%] flex flex-col xl:gap-[33px] lg:gap-[8px]">
          ...
          <BodyText className="text-white text-center lg:text-start max-w-full">
            ...
            geven. Met al onze ervaring zijn wij dan ook dé specialist voor wat betreft het renoveren van vloeren en
            trappen. Wij zijn uitgegroeid van een eenmanszaak tot een volwaardig bedrijf met vestigingen door heel
            Nederland. De groei van GreenTeam komt voort uit de gedachte dat er altijd iets beter kan, wij willen ons
            graag onderscheiden van andere aanbieders op de markt. Dit doen wij door continu in beweging te blijven en
            te optimaliseren tijdens het volgen van onze missie om de wereld een stukje groener en beter te maken.
          </BodyText>
