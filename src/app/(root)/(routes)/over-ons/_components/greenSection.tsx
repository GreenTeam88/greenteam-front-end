...
export const GreenSection = () => {
  return (
    <div className="flex relative lg:justify-end    h-fit  py-5 lg:px-0 lg:py-0 px-4 flex-col lg:flex-row w-full">
      <div style={{ width: '80vw' }} className="absolute top-0 left-0   overflow-visible  h-full lg:-ml-[7%]">
        <img className=" hidden w-full h-full  lg:block object-cover" src="/aboutUs/greenBg.png" />
        <div className="lg:absolute py-4 max-w-[70%] relative  lg:py-0 lg:top-1/2 items-center lg:items-start lg:-translate-y-1/2 lg:left-[20%] flex flex-col xl:gap-[33px] lg:gap-[8px]">
          ...
          <BodyText className="text-white max-w-full">
      ...
      <div className="flex items-center justify-center w-[25vw] bg-white h-[383px]">
