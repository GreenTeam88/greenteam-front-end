...
const config: InfoCardProps = {
  ...
  paragraphs: [
    <>
      ...
      onderhouden moeten worden en worden geschuurd. Op deze manier kan u alle gebruikssporen laten verdwijnen en is uw
    ...
    <>
      ...
      wordt overgeslagen. Zo bent u verzekerd van het beste eindresultaat.
    </>,
    <>
